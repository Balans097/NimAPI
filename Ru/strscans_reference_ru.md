...
> Для извлечения структурированных данных из строк — зачастую проще и быстрее регулярных выражений.
> Без накладных расходов во время выполнения программы, поскольку шаблоны раскрываются на этапе компиляции.
